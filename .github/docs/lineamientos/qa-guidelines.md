...
## 9. Anexo obligatorio para TicketRush

### Flujos críticos mínimos
- Reserva exitosa de ticket disponible.
- Rechazo de reserva por concurrencia o ticket no disponible.
- Pago aprobado de ticket reservado.
- Pago rechazado con liberación del ticket.
- Pago tardío fuera de TTL.

### Riesgos que deben evaluarse siempre
- consistencia eventual,
- concurrencia en reserva,
- duplicidad de eventos,
- discrepancias entre contrato HTTP, evento y estado persistido,
- regresión de hooks/UI que monitorean el estado del ticket.

### Evidencia mínima recomendada
- pruebas por servicio afectado,
- validación del flujo distribuido extremo a extremo cuando el cambio cruza servicios,
- confirmación de que frontend y backend interpretan igual los estados del dominio.
